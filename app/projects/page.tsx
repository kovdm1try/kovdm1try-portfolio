    ...
    >
      <div className={sectionClass}>
        <div className="w-full min-h-screen flex flex-col relative items-center justify-between box-border p-2.5">
          ...
          <div className="h-10" />
          <div className="z-1">
            <div className="font-jetbrains text-muted-foreground w-full text-center text-sm min-[800px]:text-base">
              {t.projects.eyebrow}
            </div>
            <div className="w-full text-center leading-none mb-3 [word-spacing:0.35em] min-[800px]:[word-spacing:0.6em]">
              <span className="font-[800] text-[52px] min-[800px]:text-[110px] text-gray-900">
                {t.projects.titleMain}
              </span>{' '}
              <span className="font-[800] text-[52px] min-[800px]:text-[110px] text-primary">
            ...
            <div className="font-jetbrains text-gray-900 mt-6 min-[800px]:mt-10 w-full text-center text-sm min-[800px]:text-base">
              <span className="text-muted-foreground">{t.projects.countLabel}</span> 02
            </div>
          </div>
      ...
      <div className={sectionClass}>
        <OutroSection
          title={t.projects.outroTitle}
          accent={t.projects.outroAccent}
          subtitle={t.projects.outroSubtitle}
          primaryLabel={t.projects.outroPrimaryLabel}
          primaryHref="https://github.com/kovdm1try"
          primaryIcon={<SiGithub size={16} />}
          secondaryLabel={t.projects.outroSecondaryLabel}
